...
import { Code, Database, Monitor, Binary, Network, CloudCog, ZapIcon, Sparkles } from 'lucide-react';
...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      { name: "Quantum Programming", level: 75 },
      { name: "Quantum Algorithms", level: 70 },
      { name: "Quantum Simulations", level: 65 }
    ]
  },
  {
    name: "Blockchain",
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
          <div className="animate-on-scroll">
            ...
            <p className="text-muted-foreground mb-6">
              With expertise spanning from full-stack development to quantum computing and AI, I bring a diverse skill set to solve complex technical challenges.
            </p>
